package cn.itcast.bos.web.util;
 ...
 * @version 1.0 ，2017年5月13日  下午11:56:19
 */
public class CheckImgUtil extends HttpServlet {
	 ...
	 * @throws IOExcetption
	 */
	public static void getImgeCode(HttpServletRequest request, HttpServletResponse response)
		...
		//将生成的验证码存到session中
		request.getSession().setAttribute("coder", builder);
