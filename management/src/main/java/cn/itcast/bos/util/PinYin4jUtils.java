...
public class PinYin4jUtils {
         ...
         * @return 转换后的拼音
         */
         public static String convertHeadToUpperCase(String hanzi) {
                 // 用户存放转换后的结果
                 StringBuffer buffer = new StringBuffer();
                 for (char ch : hanzi.toCharArray()) {
                         String header = hanziToPinyin(String.valueOf(ch)).substring(0,1).toUpperCase();
                         String body = hanziToPinyin(String.valueOf(ch)).substring(1).toLowerCase();
	...
	public static void main(String[] args) {
		...
		String s4 ="北京市";
		System.out.println(convertHeadToUpperCase(s4));
	}
}
